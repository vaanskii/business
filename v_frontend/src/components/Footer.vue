<template>
    <footer class="lg:grid lg:grid-cols-5 bg-[#4a4b4d] mt-20">
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
          <div>
            <p>
              ...
              <p
                href=""
                class="block text-2xl font-medium text-gray-900 hover:opacity-75 sm:text-3xl dark:text-white cursor-pointer"
              >
                0123456789
              </p>
            </p>
            ...
            <ul class="mt-8 flex gap-6">
              ...
              <li>
                <a
                  href="https://www.instagram.com/vaanskii/"
                  rel="noreferrer"
                  target="_blank"
                  class="text-gray-700 transition hover:opacity-75 dark:text-gray-200"
                >
